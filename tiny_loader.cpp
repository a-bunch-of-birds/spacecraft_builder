...
/*
Adapted from the original class implementation by Dr. Martin for this MSc project
*/
...
void TinyObjLoader::load_obj(string inputfile, bool debugPrint)
{
	...
	string err, warn;
	/*don't touch the comment below: the tiny_obj_loader.h had a problem with their commented header which invalidated all of the method calls for the file*/
...
void TinyObjLoader::drawObject(int drawmode)
{
	...
	else
	{
		...
		//glDrawElements(GL_TRIANGLES, numPIndexes, GL_UNSIGNED_INT, 0);
